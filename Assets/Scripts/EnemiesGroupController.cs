...
#pragma warning restore 0649
    ...
    public bool IsCanShoot => _shootRechargeDelay == 0;
    ...
    private void Init()
    {
        _enemies = GetEnemiesInGrid(out var count);
        _indexDirection = 0;
        _count = count;
    ...
    private Vector3 GetCurrentDirection() => GetDirection(GetCurrentMoveDirectionID());
    private Vector3 GetDirection(MoveDirectionID dir) => _directions[dir];
    private MoveDirectionID GetCurrentMoveDirectionID() => GetMoveDirectionID(_indexDirection);
    private MoveDirectionID GetMoveDirectionID(int index) => _pathFromDirections[index];
    ...
    private void Dead(EnemyController obj) => OnDead?.Invoke(obj);
}
